      ...
      <div className="relative mx-auto max-w-[1180px] px-5 py-8 sm:px-6 sm:py-9 lg:px-8 lg:py-10">
        ...
        <div className="mt-7 grid gap-7 md:grid-cols-[1fr_1.4fr] md:gap-10">
          <section className="text-center md:text-right" dir="rtl">
            ...
            <p className="mt-1.5 text-[12px] leading-6 text-white/65" style={{ fontFamily: 'IBM Plex Sans Arabic, sans-serif' }}>6 El-Sad El-Aaly St. - Dokki - Giza</p>
            <div className="mt-5">
          ...
          <section className="border-t border-white/[0.06] pt-6 text-center md:border-t-0 md:border-r md:pr-10 md:pt-0" dir="rtl">
            ...
            <div className="footer-phone-grid mx-auto mt-4 grid max-w-[570px] grid-cols-2 gap-x-8 gap-y-1.5 text-[11px] leading-5 text-white/55 sm:grid-cols-3 lg:grid-cols-4" dir="ltr" style={{ fontFamily: 'Inter, sans-serif' }}>
