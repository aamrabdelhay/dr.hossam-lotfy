    ...
    <footer className="relative mt-12 overflow-hidden border-t border-white/[0.08] bg-[#0A101D] text-white">
      ...
      <div className="relative mx-auto max-w-[1180px] px-5 py-9 sm:px-6 lg:px-8">
        <header className="text-center">
          <p className="text-[17px] tracking-[3px] text-white sm:text-[19px]" style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 600 }}>Dr.hossam lotfi</p>
        ...
        <nav aria-label="Footer navigation" className="mx-auto mt-7 max-w-[980px] border-t border-white/[0.06] pt-5">
          <ul className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2" dir="rtl">{quickLinks.map(([href, label]) => <li key={href}><Link href={href} className="text-[10px] text-white/40 transition-colors hover:text-white/75" style={{ fontFamily: 'IBM Plex Sans Arabic, sans-serif' }}>{label}</Link></li>)}</ul>
        </nav>
      </div>

      <div className="relative border-t border-white/[0.06] px-4 py-4 sm:px-6">
        <p className="text-center text-[9px] uppercase tracking-[1.2px] text-white/30" style={{ fontFamily: 'Inter, sans-serif' }}>© 2026 Dr.hossam lotfi LAW FIRM</p>
