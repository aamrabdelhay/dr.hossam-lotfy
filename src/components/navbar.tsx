        ...
        <div className="ms-auto flex items-center gap-2 lg:ms-4">
          ...
          {!session ? loginLink : session.role === 'admin' ? (
            <div className="flex items-center gap-2">
              <Link href="/admin" className="flex items-center gap-1.5 rounded-full px-2.5 py-1.5 text-[11px] font-semibold text-navy-600 transition-all hover:scale-[1.02] hover:bg-navy-900/[0.06] hover:text-navy-950 active:scale-[0.98]" style={{ fontFamily: 'IBM Plex Sans Arabic, sans-serif' }} aria-label="الإدارة" title="الإدارة"><LayoutDashboard size={14} className="text-gold-600" /><span className="hidden sm:inline">الإدارة</span></Link>
