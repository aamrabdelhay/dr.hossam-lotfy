  ...
  return (
    <div className="mx-auto flex w-full max-w-[1440px] gap-5 px-4 py-5 sm:px-6">
      ...
      <section className="min-w-0 flex-1 space-y-4">
        {/* لوحة مؤشرات بصرية: ملخص المكتب في أول 3 ثوانٍ */}
        ...
        <div className="sticky top-[84px] space-y-4">
          <Card className="p-4">
            ...
            <ul className="space-y-1 text-[12.5px] font-bold">
              ...
              {session?.role === 'admin' && (
                <li>
                  <Link href="/admin?tab=cases" className="flex items-center gap-2 rounded-md px-2 py-1.5 text-[12.5px] font-bold text-navy-600 hover:bg-ivory-100 hover:text-navy-950">
                    <BriefcaseBusiness size={14} className="text-gold-600" />
                    ملفات القضايا
                  </Link>
                </li>
