...
export default async function LocationsPage() {
  ...
  const rows: LocationRow[] = locations.map((l) => {
    ...
    return {
      ...
      category: categoryForType(l.type as string),
      subType: l.subType,
        ...
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-[13px] font-medium text-navy-400">
              محاكم، نيابات، جهات حكومية وخدمية — مع بحث وخدمات ومسافة من مكتب الدقي.
            </p>
          </div>
          <div className="rounded-lg border border-gold-500/20 bg-gold-500/5 px-3 py-2 text-[11px] font-bold text-navy-600">
            نقطة المرجع: الدقي – الجيزة · 30.0380, 31.2000
          </div>
        </div>
      </div>
