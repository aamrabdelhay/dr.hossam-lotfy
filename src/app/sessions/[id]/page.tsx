    ...
    <div className="page-enter mx-auto flex w-full max-w-[1440px] gap-5 px-4 py-5 sm:px-6">
      ...
      <div className="min-w-0 flex-1 space-y-5">
        <Card className="overflow-hidden">
          <div className="masthead px-5 py-4"><div className="flex flex-wrap items-center gap-3"><div className="min-w-0 flex-1"><p className="text-[11px] font-bold text-[var(--masthead-seal)]">تفاصيل</p><h1 className="mt-1 text-lg font-extrabold leading-7 text-[var(--masthead-fg)] sm:text-xl">{task.description}</h1></div><div className="flex flex-wrap items-center gap-2"><StatusBadge status={task.status} />{task.scheduledDate && task.status !== 'COMPLETED' && <UrgencyBadge urgency={task.urgency} />}</div></div></div>
