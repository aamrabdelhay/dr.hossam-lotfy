...
export default function AdminLoginPage() {
  return (
    <div className="relative mx-auto flex w-full max-w-md flex-col items-center overflow-hidden px-4 py-20">
      <span aria-hidden className="pointer-events-none absolute inset-x-0 top-0 h-[420px] bg-[radial-gradient(560px_280px_at_50%_-60px,var(--accent-soft),transparent_70%)]" />
      <span aria-hidden className="pointer-events-none absolute -start-24 top-40 h-64 w-64 rounded-full bg-navy-600/10 blur-3xl" />

      <div className="relative w-full rounded-2xl border border-line bg-surface/90 p-8 shadow-lift backdrop-blur-sm sm:p-10">
        <div className="w-full text-center">
          <div className="mx-auto mb-6 h-20 w-20 overflow-hidden rounded-2xl shadow-glow-gold ring-2 ring-accent/30">
      ...
      <p
        ...
        style={{ fontFamily: 'var(--font-serif-en)', letterSpacing: '3px' }}
      >
