...
export default async function NotificationsPage() {
  ...
  const TYPE_LABEL: Record<string, string> = { TASK_ASSIGNED: 'مهمة جديدة', TASK_EDITED: 'تعديل', SESSION_CRITICAL: 'جلسة حرجة', SESSION_TOMORROW: 'جلسة غداً', COMMENT: 'تعليق', TASK_COMPLETED: 'تم التنفيذ', TASK_DELETED: 'حذف مهمة', POST_CREATED: 'بوست جديد', ANNOUNCEMENT: 'إعلان', PERSONAL_REMINDER: 'تذكير شخصي', LAWYER_FIRST_LOGIN: 'أول تسجيل دخول' };
