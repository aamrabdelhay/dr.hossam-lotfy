#!/usr/bin/env node
/**
 * Lawyer Guide location sync — 134 official places
 ...
 * استثمار، خبراء، سجل مدني، نيابة، ديوان محافظة).
 *
 ...
 *   • creates/updates the 134 locations with the full directory data,
 *   • links each location to its Lawyer-Guide category (47 `cat-*` categories
 *     seeded by the lawyer_guide migration),
...
console.log('🧭 [seed-lawyer-guide] syncing 134 locations (119 courts + 15 government offices)…');
try {
  await seedLocations();
